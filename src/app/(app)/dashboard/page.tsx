...
export default async function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-lg px-5 pt-8 pb-24">
      ...
      {/* Hydration (tracked, not scored — distinct blue) */}
      <HydrationCard />

      {/* Scan a food entry */}
      <a href="/scan" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-accent-500"><ScanIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Scan a food</p>
            <p className="text-xs text-slate-400">Log macros from a barcode</p>
          </div>
        </div>
      ...
      {/* Intake entry (caffeine, alcohol, supplements) */}
      <a href="/intake" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-sky-500"><DropletIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Intake</p>
            <p className="text-xs text-slate-400">Log caffeine, alcohol &amp; supplements</p>
          </div>
        </div>
        <svg className="h-5 w-5 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
      </a>
      ...
      {/* Championship League entry */}
      <a href="/championship" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-amber-500"><TrophyIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Championship League</p>
            <p className="text-xs text-slate-400">Head-to-head matchups with friends</p>
          </div>
        </div>
        <svg className="h-5 w-5 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
      </a>
      ...
      <a href="/friends" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-accent-500"><UsersIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Friends</p>
            <p className="text-xs text-slate-400">Compare your Flow and climb the leaderboard</p>
          </div>
        </div>
        <svg className="h-5 w-5 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
      </a>
      ...
      {/* Plans entry */}
      <a href="/plans" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-accent-500"><ChartBarIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Plans</p>
            <p className="text-xs text-slate-400">Follow a day-by-day training or nutrition plan</p>
          </div>
        </div>
        <svg className="h-5 w-5 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
      </a>
      ...
      {/* Goals entry */}
      <a href="/goals" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-accent-500"><TrendUpIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Goals</p>
            <p className="text-xs text-slate-400">Set targets and track your progress</p>
          </div>
        </div>
        <svg className="h-5 w-5 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
      </a>
      ...
      <a href="/cycle" className="card mb-6 flex items-center justify-between transition-all hover:shadow-glass-lg active:scale-[0.99]">
        <div className="flex items-center gap-3">
          <span className="text-rose-400"><MoonIcon /></span>
          <div>
            <p className="text-sm font-semibold text-slate-900 dark:text-white">Cycle</p>
            <p className="text-xs text-slate-400">Track your cycle, phase &amp; symptoms (private)</p>
          </div>
        </div>
        <svg className="h-5 w-5 text-slate-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6" /></svg>
      </a>
...
function UsersIcon() {
  return (<svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" /></svg>);
}
function TrophyIcon() {
